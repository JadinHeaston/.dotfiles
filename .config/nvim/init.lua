...
require("lazy").setup({
	...
	{ -- File explorer/editor
		...
		config = function()
			...
			local detail = false -- Sets default detail state.
			require("oil").setup({
				columns = { "icon" },
				keymaps = {
					["<C-h>"] = false,
			...
			vim.keymap.set(
				...
				{ desc = "Open parent directory (Oil - Floating)" }
			)
		end,
	},
	...
	-- 	-- Requires SSHFS (L: https://github.com/libfuse/sshfs | W: https://github.com/winfsp/sshfs-win)
